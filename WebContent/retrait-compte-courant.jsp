...
<title>Page de Retrait du compte courant</title>
...
<body>
	...
	<%
		CompteCourant ccUpdate = (CompteCourant)request.getAttribute("compte_retrait");
	%>
	...
	<form method="POST" action="gestion-compte-servlet">
		...
		<table>
			...
			<tr>
				<td>Retrait max autorisé :</td>
				<td><p> <%=ccUpdate.getDecouvertAutorise()+ccUpdate.getSoldeCompte()%> </p>
			</tr>
			<tr>
				<td>Entrer la valeur à retirer :</td>
				<td><input type="text"  name = "p-retrait" /> </td>
			</tr>			
			...
			<tr>
				<td><input type="hidden" value="update-retraitCC" name="action"/></td>
			</tr>			
