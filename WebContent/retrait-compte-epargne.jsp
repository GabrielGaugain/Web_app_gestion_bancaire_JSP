...
<body>
	...
	<%
		CompteEpargne ccUpdate = (CompteEpargne)request.getAttribute("compte_retrait");
	%>
	...
	<form method="POST" action="gestion-compte-servlet">
		...
		<table>
			...
			<tr>
				...
				<td><p> <%=ccUpdate.getSoldeCompte()%> </p>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="hidden" value="update-retraitCE" name="action"/></td>
			</tr>			
